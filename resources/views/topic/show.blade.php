            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{url('/topic/submit',['topic'=>$topic->id])}}" method="POST">
                            {{csrf_field()}}
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="blog-post" style="margin-top: 30px">
                            <p class=""><a href="{{url('/user',['user'=>$post->user->id])}}">{{$post->user->name}}</a> {{$post->created_at->diffForHumans()}}</p>
                            <p class=""><a href="{{url('/posts',['post'=>$post->id])}}" >{{$post->title}}</a></p>
